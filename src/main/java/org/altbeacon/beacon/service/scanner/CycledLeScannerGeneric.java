...
public class CycledLeScannerGeneric extends CycledLeScanner {
    ...
    public CycledLeScannerGeneric(Context context, long scanPeriod, long betweenScanPeriod, boolean backgroundFlag, CycledLeScanCallback cycledLeScanCallback, BluetoothCrashResolver crashResolver) {
    ...
    protected void startScan() {
        ...
        if (!mMainScanCycleActive) {
            ...
            filters = new ScanFilterUtils().createScanFiltersForBeaconParsersGeneric(
            ...
            filters = new ScanFilterUtils().createWildcardScanFiltersGeneric();
        }
    ...
    private void postStartLeScan(final List<ScanFilter> filters, final ScanSettings settings) {
        final BluetoothLeScannerCompat scanner = getScanner();
        if (scanner == null) {
            return;
        }
        ...
        if (leScanCallback == null) {
            leScanCallback = new ScanCallback() {
                ...
                public void onScanFailed(int errorCode) {
                    ...
                    LocalBroadcastManager.getInstance(CycledLeScannerGeneric.this.mContext).sendBroadcast(intent);
                    switch (errorCode) {
